...
public class JWTAutorizacao extends BasicAuthenticationFilter{
	private final CustomUserDetails customUserDetails;
	
	public JWTAutorizacao(AuthenticationManager authenticationManager, CustomUserDetails customUserDetails) {
